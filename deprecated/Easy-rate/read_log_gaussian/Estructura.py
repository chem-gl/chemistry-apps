...
class Estructura(object):
    ...
    def __init__(self)->None:
        ...
        self.Thermal_Free_Energies:ThermalFreeEnergies = ThermalFreeEnergies()#   Sum of electronic and thermal Free Energies
        self.Atributos.append(self.Thermal_Free_Energies)
