"""apps.py: Configuración Django de la app científica molar_fractions.

Objetivo del archivo:
- Registrar la app y su plugin en el startup de Django.
...
class MolarFractionsConfig(AppConfig):
    """Registra la app de fracciones molares en el ecosistema científico."""

    default_auto_field = "django.db.models.BigAutoField"
    name = APP_CONFIG_NAME

    def ready(self) -> None:
        """Registra definición de app y publica el plugin en runtime."""
