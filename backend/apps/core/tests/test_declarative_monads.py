"""test_declarative_monads.py: Pruebas de los monads Result y Task.

Valida que Result[S, E] y Task[S, E] funcionan correctamente para
composición funcional de éxito/error sin acoplamiento HTTP.
"""
