...
from ._catalog_schemas import (
    SmileitManualSubstituentInputSerializer,
    SmileitSubstituentReferenceInputSerializer,
)
...
# --- Los serializers de catálogo, patrones e inspección están en _catalog_schemas.py ---
# Re-exportados arriba vía `from ._catalog_schemas import (...)`
