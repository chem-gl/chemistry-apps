...
import { TunnelResult } from './tunnelResult';
import { TunnelParameters } from './tunnelParameters';


/**
 * Respuesta estable para jobs de la app Tunnel.
 */
export interface TunnelJobResponse { 
    readonly id: string;
    /**
    ...
    results?: TunnelResult | null;
    readonly error_trace: string | null;
    readonly created_at: string;
    readonly updated_at: string;
}
export namespace TunnelJobResponse {
}
