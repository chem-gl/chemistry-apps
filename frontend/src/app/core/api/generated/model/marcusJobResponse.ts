...
import { MarcusParameters } from './marcusParameters';
import { MarcusResult } from './marcusResult';


/**
 * Serializer de salida para jobs de la app Marcus.
 */
export interface MarcusJobResponse { 
    readonly id: string;
    /**
...
export namespace MarcusJobResponse {
}
